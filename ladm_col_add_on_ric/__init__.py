...
from ladm_col_add_on_ric.config.general_config import (ADD_ON_PLUGIN_NAME,
                                                       LADM_COL_PLUGIN_ID,
...
def classFactory(iface):
    ...
    if ladmcol_version != '__error__':  # LADM-COL plugin found
        if ladmcol_version == LADM_COL_REQUIRED_VERSION:  # TODO: improve way to check minimum dependency
            from ladm_col_add_on_ric.ladm_col_add_on_ric import LADMCOLAddOnRIC
            return LADMCOLAddOnRIC(iface)
